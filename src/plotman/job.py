...
>>>>>>> 8dde509... refactor: isolate chia cli parsing and test it
...
>>>>>>> af115b6... Use chia's own 'chia plots create' argument parser
=======
...
>>>>>>> a4737c0... fix: skip jobs whose arguments fail to be parsed
            for f in self.proc.open_files():
                print(f.path)
